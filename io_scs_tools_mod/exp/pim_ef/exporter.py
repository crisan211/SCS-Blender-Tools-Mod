...
from io_scs_tools_mod.consts import Operators as _OP_consts
from io_scs_tools_mod.consts import PrefabLocators as _PL_consts
from io_scs_tools_mod.exp.pim_ef.header import Header
from io_scs_tools_mod.exp.pim_ef.globall import Globall
from io_scs_tools_mod.exp.pim_ef.material import Material
from io_scs_tools_mod.exp.pim_ef.piece import Piece
from io_scs_tools_mod.exp.pim_ef.part import Part
from io_scs_tools_mod.exp.pim_ef.locator import Locator
from io_scs_tools_mod.exp.pim_ef.bones import Bones
from io_scs_tools_mod.exp.pim_ef.piece_skin import PieceSkin
from io_scs_tools_mod.exp.pim_ef.piece_skin import PieceSkinStream
from io_scs_tools_mod.internals.containers import pix as _pix_container
from io_scs_tools_mod.utils import mesh as _mesh_utils
from io_scs_tools_mod.utils import name as _name_utils
...
from io_scs_tools_mod.utils.convert import change_to_scs_uv_coordinates as _change_to_scs_uv_coordinates
from io_scs_tools_mod.utils.convert import get_scs_transformation_components as _get_scs_transformation_components
from io_scs_tools_mod.utils.convert import scs_to_blend_matrix as _scs_to_blend_matrix
from io_scs_tools_mod.utils.convert import hookup_name_to_hookup_id as _hookup_name_to_hookup_id
...
def execute(dirpath, name_suffix, root_object, armature_object, skeleton_filepath, mesh_objects, model_locators,
    ...
    :type used_parts: io_scs_tools_mod.exp.transition_structs.parts.PartsTrans
    :param used_materials: materials transitional structure for storing used materials inside this PIM export
    :type used_materials: io_scs_tools_mod.exp.transition_structs.materials.MaterialsTrans
    :param used_bones: bones transitional structure for storing used bones inside this PIM export
    :type used_bones: io_scs_tools_mod.exp.transition_structs.bones.BonesTrans
    :param used_terrain_points: terrain points transitional structure for storing used terrain points
    :type used_terrain_points: io_scs_tools_mod.exp.transition_structs.terrain_points.TerrainPntsTrans
