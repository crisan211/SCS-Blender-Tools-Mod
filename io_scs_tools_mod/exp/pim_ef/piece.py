...
from io_scs_tools_mod.exp.pim_ef.piece_stream import Stream
from io_scs_tools_mod.exp.pim_ef.piece_face import Face
...
class Piece:
    ...
    def add_face(self, material, vert_indicies, vert_normals, vert_uvs, uvs_names, uvs_aliases, vert_rgbas, rgbas_names):
        ...
        :type material: io_scs_tools_mod.exp.pim.material.Material
