...
from io_scs_tools_mod.exp import tobj as _tobj
...
def fill_part_list(parts, used_parts_names, all_parts=False):
    ...
    :type parts: io_scs_tools_mod.properties.object.ObjectPartInventoryItem | list[io_scs_tools_mod.properties.object.ObjectVariantPartInclusionItem]
