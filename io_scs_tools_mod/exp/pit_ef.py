...
import bpy
import os
from io_scs_tools_mod.consts import Variant as _VARIANT_consts
from io_scs_tools_mod.exp.pit import default_material
from io_scs_tools_mod.exp.pit import get_texture_path_from_material
from io_scs_tools_mod.exp.pit import fill_material_sections
from io_scs_tools_mod.exp.pit import fill_part_list
from io_scs_tools_mod.exp.pit import fill_header_section
from io_scs_tools_mod.exp.pit import fill_look_sections
from io_scs_tools_mod.exp.pit import fill_variant_sections
from io_scs_tools_mod.exp.pit import fill_comment_header_section
from io_scs_tools_mod.exp.pit import fill_global_section
from io_scs_tools_mod.internals import looks as _looks
...
def _get_flavor_types(preset, flavors_str):
    ...
    :type preset: io_scs_tools_mod.internals.shader_presets.ui_shader_preset_item.UIShaderPresetItem
    :param flavors_str:
