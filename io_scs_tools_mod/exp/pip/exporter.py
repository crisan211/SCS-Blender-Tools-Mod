...
from io_scs_tools_mod.exp.pip.curve import Curve
from io_scs_tools_mod.exp.pip.globall import Globall
from io_scs_tools_mod.exp.pip.header import Header
from io_scs_tools_mod.exp.pip.intersection import Intersection
from io_scs_tools_mod.exp.pip.map_point import MapPoint
from io_scs_tools_mod.exp.pip.node import Node
from io_scs_tools_mod.exp.pip.semaphore import Semaphore
from io_scs_tools_mod.exp.pip.sign import Sign
from io_scs_tools_mod.exp.pip.spawn_point import SpawnPoint
from io_scs_tools_mod.exp.pip.trigger_point import TriggerPoint
...
from io_scs_tools_mod.utils.name import tokenize_name as _tokenize_name
...
def __get_curve__(pip_curves, index, locator_name):
    ...
    :type pip_curves: dict[int, io_scs_tools_mod.exp.pip.curve.Curve]
    ...
    :rtype: io_scs_tools_mod.exp.pip.curve.Curve
    """
...
def __get_map_point__(pip_map_points, locator_name):
    ...
    :type pip_map_points: dict[str, io_scs_tools_mod.exp.pip.map_point.MapPoint
    :param locator_name: name of the locator for which map point shall be returned
    :type locator_name: str
    :return: map point class instance
    :rtype: io_scs_tools_mod.exp.pip.map_point.MapPoint
    """
...
def __get_trigger_point__(pip_trigger_points, locator_name):
    ...
    :type pip_trigger_points: dict[str, io_scs_tools_mod.exp.pip.trigger_point.TriggerPoint
    :param locator_name: name of the locator for which trigger point shall be returned
    :type locator_name: str
    :return: map point class instance
    :rtype: io_scs_tools_mod.exp.pip.trigger_point.TriggerPoint
    """
...
def execute(dirpath, filename, name_suffix, prefab_locator_list, offset_matrix, used_parts, used_terrain_points):
    ...
    for locator in control_node_locs.values():
        ...
        """:type: io_scs_tools_mod.properties.object.ObjectSCSTools"""
