...
from io_scs_tools_mod.utils import curve as _curve_utils
...
def load(filepath, terrain_points_trans):
    ...
    :type terrain_points_trans: io_scs_tools_mod.imp.transition_structs.terrain_points.TerrainPntsTrans
