...
from io_scs_tools_mod.utils.info import get_tools_version as _get_tools_version
from io_scs_tools_mod.utils.info import get_blender_version as _get_blender_version
...
def _fill_header_section(file_name, output_type):
    ...
    header_section.props.append(("Source", "Blender " + blender_version + blender_build + ", SCS Blender Tools Mod: " + str(_get_tools_version())))
