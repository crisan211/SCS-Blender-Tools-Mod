...
from io_scs_tools_mod.properties.dynamic import scene
from io_scs_tools_mod.properties.dynamic import object
...
class DynamicProps:
    ...
    def register(scope, property_name, property_type, default):
        ...
        def getter(self):
            ...
            prefs = bpy.context.preferences.addons["io_scs_tools_mod"].preferences
