...
from io_scs_tools_mod.internals import preview_models as _preview_models
from io_scs_tools_mod.internals.callbacks import open_gl as _open_gl_callback
from io_scs_tools_mod.internals.callbacks import lighting_east_lock as _lighting_east_lock_callback
from io_scs_tools_mod.internals.containers import config as _config_container
...
from io_scs_tools_mod.utils import info as _info_utils
...
def init_scs_tools():
    ...
    lprint("I Initialization of SCS scene, BT Mod version: " + _info_utils.get_tools_version())
    ...
    if not _info_utils.is_blender_able_to_run_tools():
        ...
        message = "Your Blender version %s is outdated, all SCS Blender Tools Mod functionalities were internally disabled.\n\t   " \
        ...
        bpy.ops.preferences.addon_disable(module="io_scs_tools_mod")
        ...
        from io_scs_tools_mod.operators.wm import SCS_TOOLS_OT_ShowMessageInPopup
        ...
        bpy.ops.wm.scs_tools_show_message_in_popup(context, 'INVOKE_DEFAULT',
                                                   is_modal=True,
                                                   title="SCS Blender Tools Mod Initialization Problem",
