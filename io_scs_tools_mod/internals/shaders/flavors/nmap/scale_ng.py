...
def __create_nmap_scale_group__():
    ...
    # inputs defining
    nmap_tex_color_socket = nmap_scale_g.interface.new_socket(name = "NMap Tex Color", in_out='INPUT', socket_type = 'NodeSocketColor')
    nmap_tex_color_socket.attribute_domain = 'POINT'

    or_normal_socket = nmap_scale_g.interface.new_socket(name = "Original Normal", in_out='INPUT', socket_type = 'NodeSocketVector')
    or_normal_socket.attribute_domain = 'POINT'

    mod_normal_socket = nmap_scale_g.interface.new_socket(name = "Modified Normal", in_out='INPUT', socket_type = 'NodeSocketVector')
    mod_normal_socket.attribute_domain = 'POINT'

    input_n = nmap_scale_g.nodes.new("NodeGroupInput")
    input_n.location = (0, 0)

    # outputs defining
    normal_socket = nmap_scale_g.interface.new_socket(name = "Normal", in_out='OUTPUT', socket_type = 'NodeSocketVector')
