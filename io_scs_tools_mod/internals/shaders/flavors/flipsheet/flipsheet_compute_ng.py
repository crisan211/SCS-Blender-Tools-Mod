...
import bpy
from io_scs_tools_mod.internals.shaders.std_node_groups import animsheet_frame_ng
...
def __create_node_group__():
    ...
    # outputs defining
    UV_socket = fadesheet_compute_g.interface.new_socket(name = "UV", in_out='OUTPUT', socket_type = 'NodeSocketVector')
    UV_socket.attribute_domain = 'POINT'
