...
import bpy
from io_scs_tools_mod.internals.shaders.std_node_groups import animsheet_xfade_ng
...
def __create_node_group__():
    ...
    # inputs defining
    fps_socket = fadesheet_compute_g.interface.new_socket(name = "FPS", in_out='INPUT', socket_type = 'NodeSocketFloat')
    fps_socket.attribute_domain = 'POINT'

    FramesRow_socket = fadesheet_compute_g.interface.new_socket(name = "FramesRow", in_out='INPUT', socket_type = 'NodeSocketFloat')
    FramesRow_socket.attribute_domain = 'POINT'

    FramesTotal_socket = fadesheet_compute_g.interface.new_socket(name = "FramesTotal", in_out='INPUT', socket_type = 'NodeSocketFloat')
    FramesTotal_socket.attribute_domain = 'POINT'

    FrameSize_socket = fadesheet_compute_g.interface.new_socket(name = "FrameSize", in_out='INPUT', socket_type = 'NodeSocketVector')
    FrameSize_socket.attribute_domain = 'POINT'

    UV_socket = fadesheet_compute_g.interface.new_socket(name = "UV", in_out='INPUT', socket_type = 'NodeSocketVector')
    UV_socket.attribute_domain = 'POINT'

    # outputs defining
    UV0_socket = fadesheet_compute_g.interface.new_socket(name = "UV0", in_out='OUTPUT', socket_type = 'NodeSocketVector')
    UV0_socket.attribute_domain = 'POINT'

    UV1_socket = fadesheet_compute_g.interface.new_socket(name = "UV1", in_out='OUTPUT', socket_type = 'NodeSocketVector')
    UV1_socket.attribute_domain = 'POINT'

    FrameBlend_socket = fadesheet_compute_g.interface.new_socket(name = "FrameBlend", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
