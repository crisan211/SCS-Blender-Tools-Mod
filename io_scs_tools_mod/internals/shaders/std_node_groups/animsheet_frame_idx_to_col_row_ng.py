...
def __create_node_group__():
    ...
    # inputs defining
    frameIndex_socket = animsheet_frame_idx_to_col_row_g.interface.new_socket(name = "FrameIndex", in_out='INPUT', socket_type = 'NodeSocketFloat')
    frameIndex_socket.attribute_domain = 'POINT'

    framesRow_socket = animsheet_frame_idx_to_col_row_g.interface.new_socket(name = "FramesRow", in_out='INPUT', socket_type = 'NodeSocketFloat')
    framesRow_socket.attribute_domain = 'POINT'

    # outputs defining
    colIndex_socket = animsheet_frame_idx_to_col_row_g.interface.new_socket(name = "ColIndex", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
    colIndex_socket.attribute_domain = 'POINT'

    rowIndex_socket = animsheet_frame_idx_to_col_row_g.interface.new_socket(name = "RowIndex", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
    rowIndex_socket.attribute_domain = 'POINT'
