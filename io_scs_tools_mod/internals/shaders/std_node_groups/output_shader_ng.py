...
def __create_node_group__():
    ...
    # inputs defining
    color_socket = output_shader_g.interface.new_socket(name = "Color", in_out = 'INPUT', socket_type = 'NodeSocketColor')
    color_socket.attribute_domain = 'POINT'

    alpha_socket = output_shader_g.interface.new_socket(name = "Alpha", in_out = 'INPUT', socket_type = 'NodeSocketFloat')
    ...
    # outputs defining
    shader_socket = output_shader_g.interface.new_socket(name = "Shader", in_out = 'OUTPUT', socket_type = 'NodeSocketShader')
