...
def __create_node_group__():
    ...
    # inputs defining
    shader_socket = blend_add_g.interface.new_socket(name = "Shader", in_out='INPUT', socket_type = 'NodeSocketShader')
    shader_socket.attribute_domain = 'POINT'
        
    # outputs defining
    shader_socket = blend_add_g.interface.new_socket(name = "Shader", in_out='OUTPUT', socket_type = 'NodeSocketShader')
    shader_socket.attribute_domain = 'POINT'
