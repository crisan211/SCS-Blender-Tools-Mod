...
def __create_node_group__():
    ...
    # outputs defining
    frameX_socket = animsheet_xfade_g.interface.new_socket(name = "FrameX", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
    frameX_socket.attribute_domain = 'POINT'

    frameY_socket = animsheet_xfade_g.interface.new_socket(name = "FrameY", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
    frameY_socket.attribute_domain = 'POINT'
