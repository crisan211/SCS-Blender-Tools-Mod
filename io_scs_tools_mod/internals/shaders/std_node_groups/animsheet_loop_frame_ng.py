...
def __create_node_group__():
    ...
    # inputs defining
    fps_socket = animsheet_loop_frame_g.interface.new_socket(name = "FPS", in_out='INPUT', socket_type = 'NodeSocketFloat')
    fps_socket.attribute_domain = 'POINT'

    framesTotal_socket = animsheet_loop_frame_g.interface.new_socket(name = "FramesTotal", in_out='INPUT', socket_type = 'NodeSocketFloat')
    framesTotal_socket.attribute_domain = 'POINT'
        
    # outputs defining
    loopFrame_socket = animsheet_loop_frame_g.interface.new_socket(name = "LoopFrame", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
    loopFrame_socket.attribute_domain = 'POINT'
