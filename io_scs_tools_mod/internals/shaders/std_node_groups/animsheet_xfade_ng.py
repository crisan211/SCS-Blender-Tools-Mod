...
import bpy
from io_scs_tools_mod.internals.shaders.std_node_groups import animsheet_frame_idx_to_col_row_ng
from io_scs_tools_mod.internals.shaders.std_node_groups import animsheet_loop_frame_ng
...
def __create_node_group__():
    ...
    # inputs defining
    fps_socket = animsheet_xfade_g.interface.new_socket(name = "FPS", in_out='INPUT', socket_type = 'NodeSocketFloat')
    fps_socket.attribute_domain = 'POINT'

    framesTotal_socket = animsheet_xfade_g.interface.new_socket(name = "FramesTotal", in_out='INPUT', socket_type = 'NodeSocketFloat')
    framesTotal_socket.attribute_domain = 'POINT'

    framesRow_socket = animsheet_xfade_g.interface.new_socket(name = "FramesRow", in_out='INPUT', socket_type = 'NodeSocketFloat')
    framesRow_socket.attribute_domain = 'POINT'
        
    # outputs defining
    frame0X_socket = animsheet_xfade_g.interface.new_socket(name = "Frame0X", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
    frame0X_socket.attribute_domain = 'POINT'

    frame0Y_socket = animsheet_xfade_g.interface.new_socket(name = "Frame0Y", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
    frame0Y_socket.attribute_domain = 'POINT'

    frame1X_socket = animsheet_xfade_g.interface.new_socket(name = "Frame1X", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
    frame1X_socket.attribute_domain = 'POINT'

    frame1Y_socket = animsheet_xfade_g.interface.new_socket(name = "Frame1Y", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
    frame1Y_socket.attribute_domain = 'POINT'

    frameBlend_socket = animsheet_xfade_g.interface.new_socket(name = "FrameBlend", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
    frameBlend_socket.attribute_domain = 'POINT'
