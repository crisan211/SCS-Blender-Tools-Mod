...
def __create_node_group__():
    ...
    # inputs defining
    speed_socket = blend_fac_g.interface.new_socket(name = "Speed", in_out='INPUT', socket_type = 'NodeSocketFloat')
    ...
    # outputs defining
    factor_socket = blend_fac_g.interface.new_socket(name = "Factor", in_out='OUTPUT', socket_type = 'NodeSocketColor')
