...
from io_scs_tools_mod.internals.shaders.eut2.dif_spec_weight_mult2 import DifSpecWeightMult2
from io_scs_tools_mod.internals.shaders.eut2.std_node_groups import mult2_mix_ng
