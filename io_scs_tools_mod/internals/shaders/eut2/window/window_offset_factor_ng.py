...
def __create_node_group__():
    ...
    # inputs defining
    wndToEye_up_socket = offset_factor_g.interface.new_socket(name = "WndToEye Up", in_out='INPUT', socket_type = 'NodeSocketFloat')
    wndToEye_up_socket.attribute_domain = 'POINT'

    wndToEye_direction_socket = offset_factor_g.interface.new_socket(name = "WndToEye Direction", in_out='INPUT', socket_type = 'NodeSocketFloat')
    wndToEye_direction_socket.attribute_domain = 'POINT'

    input_n = offset_factor_g.nodes.new("NodeGroupInput")
    input_n.location = (0, 0)

    # outputs defining
    offset_factor_socket = offset_factor_g.interface.new_socket(name = "Offset Factor", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
