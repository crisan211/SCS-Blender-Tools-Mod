...
def __create_node_group__():
    ...
    # inputs defining
    uv_socket = final_uv_g.interface.new_socket(name = "UV", in_out='INPUT', socket_type = 'NodeSocketFloat')
    uv_socket.attribute_domain = 'POINT'

    factor_socket = final_uv_g.interface.new_socket(name = "Factor", in_out='INPUT', socket_type = 'NodeSocketFloat')
    ...
    # outputs defining
    final_uv_socket = final_uv_g.interface.new_socket(name = "Final UV", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
    final_uv_socket.attribute_domain = 'POINT'
