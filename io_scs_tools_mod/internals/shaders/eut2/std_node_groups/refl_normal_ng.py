...
def __create_refl_normal_group__():
    ...
    # inputs defining
    incoming_socket = refl_normal_g.interface.new_socket(name = "Incoming", in_out = 'INPUT', socket_type = 'NodeSocketVector')
    incoming_socket.attribute_domain = 'POINT'

    normal_socket = refl_normal_g.interface.new_socket(name = "Normal", in_out = 'INPUT', socket_type = 'NodeSocketVector')
    ...
    # outputs defining
    reflection_normal_socket = refl_normal_g.interface.new_socket(name = "Reflection Normal", in_out = 'OUTPUT', socket_type = 'NodeSocketVector')
    reflection_normal_socket.attribute_domain = 'POINT'
