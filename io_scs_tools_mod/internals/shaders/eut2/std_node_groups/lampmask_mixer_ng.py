...
def __create_node_group__():
    ...
    # inputs defining
    lm_tex_alpha_factor_socket = lampmask_g.interface.new_socket(name = "Lampmask Tex Alpha", in_out = 'INPUT', socket_type = 'NodeSocketFloat')
    lm_tex_alpha_factor_socket.attribute_domain = 'POINT'

    lm_tex_color_factor_socket = lampmask_g.interface.new_socket(name = "Lampmask Tex Color", in_out = 'INPUT', socket_type = 'NodeSocketColor')
    lm_tex_color_factor_socket.attribute_domain = 'POINT'

    uv_factor_factor_socket = lampmask_g.interface.new_socket(name = "UV Vector", in_out = 'INPUT', socket_type = 'NodeSocketVector')
    uv_factor_factor_socket.attribute_domain = 'POINT'

    input_n = lampmask_g.nodes.new("NodeGroupInput")
    input_n.location = (0, 0)

    # outputs defining
    lm_addition_color_factor_socket = lampmask_g.interface.new_socket(name = "Lampmask Addition Color", in_out = 'OUTPUT', socket_type = 'NodeSocketColor')
    lm_addition_color_factor_socket.attribute_domain = 'POINT'
