...
def __create_node_group__():
    ...
    # inputs defining
    uv_socket = scs_uvs_separate_g.interface.new_socket(name = "UV", in_out = 'INPUT', socket_type = 'NodeSocketVector')
    ...
    # outputs defining
    u_socket = scs_uvs_separate_g.interface.new_socket(name = "U", in_out = 'OUTPUT', socket_type = 'NodeSocketFloat')
    u_socket.attribute_domain = 'POINT'

    v_socket = scs_uvs_separate_g.interface.new_socket(name = "V", in_out = 'OUTPUT', socket_type = 'NodeSocketFloat')
