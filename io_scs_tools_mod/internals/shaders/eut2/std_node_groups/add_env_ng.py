...
from io_scs_tools_mod.internals.shaders.eut2.std_node_groups import fresnel_legacy_ng
from io_scs_tools_mod.internals.shaders.eut2.std_node_groups import fresnel_schlick_ng
...
def __create_node_group__():
    ...
    # inputs defining
    fresnel_type_socket = add_env_g.interface.new_socket(name = "Fresnel Type", in_out = 'INPUT', socket_type = 'NodeSocketFloat')
    fresnel_type_socket.attribute_domain = 'POINT'

    fresnel_scale_socket = add_env_g.interface.new_socket(name = "Fresnel Scale", in_out = 'INPUT', socket_type = 'NodeSocketFloat')
    fresnel_scale_socket.attribute_domain = 'POINT'

    fresnel_bias_socket = add_env_g.interface.new_socket(name = "Fresnel Bias", in_out = 'INPUT', socket_type = 'NodeSocketFloat')
    fresnel_bias_socket.attribute_domain = 'POINT'

    normal_vector_socket = add_env_g.interface.new_socket(name = "Normal Vector", in_out = 'INPUT', socket_type = 'NodeSocketVector')
    normal_vector_socket.attribute_domain = 'POINT'

    reflection_normal_vector_socket = add_env_g.interface.new_socket(name = "Reflection Normal Vector", in_out = 'INPUT', socket_type = 'NodeSocketVector')
    reflection_normal_vector_socket.attribute_domain = 'POINT'

    apply_fresnel_socket = add_env_g.interface.new_socket(name = "Apply Fresnel", in_out = 'INPUT', socket_type = 'NodeSocketFloat')
    apply_fresnel_socket.attribute_domain = 'POINT'

    reflection_texture_color_socket = add_env_g.interface.new_socket(name = "Reflection Texture Color", in_out = 'INPUT', socket_type = 'NodeSocketColor')
    reflection_texture_color_socket.attribute_domain = 'POINT'

    base_texture_alpha_socket = add_env_g.interface.new_socket(name = "Base Texture Alpha", in_out = 'INPUT', socket_type = 'NodeSocketFloat')
    base_texture_alpha_socket.attribute_domain = 'POINT'

    env_factor_color_socket = add_env_g.interface.new_socket(name = "Env Factor Color", in_out = 'INPUT', socket_type = 'NodeSocketColor')
    env_factor_color_socket.attribute_domain = 'POINT'

    specular_color_socket = add_env_g.interface.new_socket(name = "Specular Color", in_out = 'INPUT', socket_type = 'NodeSocketColor')
    specular_color_socket.attribute_domain = 'POINT'

    weighted_color_socket = add_env_g.interface.new_socket(name = "Weighted Color", in_out = 'INPUT', socket_type = 'NodeSocketColor')
    weighted_color_socket.attribute_domain = 'POINT'

    strength_multiplier_socket = add_env_g.interface.new_socket(name = "Strength Multiplier", in_out = 'INPUT', socket_type = 'NodeSocketFloat')
    strength_multiplier_socket.attribute_domain = 'POINT'    
    
    # outputs defining
    environment_addition_color_socket = add_env_g.interface.new_socket(name = "Environment Addition Color", in_out = 'OUTPUT', socket_type = 'NodeSocketColor')
    environment_addition_color_socket.attribute_domain = 'POINT'    
