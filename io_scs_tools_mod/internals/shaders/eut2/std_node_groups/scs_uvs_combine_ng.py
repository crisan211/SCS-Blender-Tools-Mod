...
def __create_node_group__():
    ...
    # inputs defining
    u_socket = scs_uvs_combine_g.interface.new_socket(name = "U", in_out = 'INPUT', socket_type = 'NodeSocketFloat')
    u_socket.attribute_domain = 'POINT'

    v_socket = scs_uvs_combine_g.interface.new_socket(name = "V", in_out = 'INPUT', socket_type = 'NodeSocketFloat')
    ...
    # outputs defining
    vector_socket = scs_uvs_combine_g.interface.new_socket(name = "Vector", in_out = 'OUTPUT', socket_type = 'NodeSocketVector')
