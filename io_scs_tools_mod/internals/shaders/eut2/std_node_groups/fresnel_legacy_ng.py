...
def __create_fresnel_group__():
    ...
    # inputs defining
    scale_socket = fresnel_g.interface.new_socket(name = "Scale", in_out = 'INPUT', socket_type = 'NodeSocketFloat')
    scale_socket.attribute_domain = 'POINT'

    bias_socket = fresnel_g.interface.new_socket(name = "Bias", in_out = 'INPUT', socket_type = 'NodeSocketFloat')
    bias_socket.attribute_domain = 'POINT'

    normal_vector_socket = fresnel_g.interface.new_socket(name = "Normal Vector", in_out = 'INPUT', socket_type = 'NodeSocketVector')
    normal_vector_socket.attribute_domain = 'POINT'

    reflection_normal_vector_socket = fresnel_g.interface.new_socket(name = "Reflection Normal Vector", in_out = 'INPUT', socket_type = 'NodeSocketVector')
    ...
    # outputs defining
    fresnel_factor_socket = fresnel_g.interface.new_socket(name = "Fresnel Factor", in_out = 'OUTPUT', socket_type = 'NodeSocketFloat')
    fresnel_factor_socket.attribute_domain = 'POINT'
