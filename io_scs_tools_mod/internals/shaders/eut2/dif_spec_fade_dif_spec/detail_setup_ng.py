...
def __create_group__():
    ...
    # inputs defining
    fade_from_socket = detail_setup_g.interface.new_socket(name = "Fade From", in_out='INPUT', socket_type = 'NodeSocketFloat')
    fade_from_socket.attribute_domain = 'POINT'

    fade_range_socket = detail_setup_g.interface.new_socket(name = "Fade Range", in_out='INPUT', socket_type = 'NodeSocketFloat')
    fade_range_socket.attribute_domain = 'POINT'

    blend_bias_socket = detail_setup_g.interface.new_socket(name = "Blend Bias", in_out='INPUT', socket_type = 'NodeSocketFloat')
    blend_bias_socket.attribute_domain = 'POINT'

    input_n = detail_setup_g.nodes.new("NodeGroupInput")
    input_n.location = (start_pos_x, start_pos_y)

    # outputs defining
    detail_strength_socket = detail_setup_g.interface.new_socket(name = "Detail Strength", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
    detail_strength_socket.attribute_domain = 'POINT'

    blend_factor_socket = detail_setup_g.interface.new_socket(name = "Blend Factor", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
    blend_factor_socket.attribute_domain = 'POINT'
