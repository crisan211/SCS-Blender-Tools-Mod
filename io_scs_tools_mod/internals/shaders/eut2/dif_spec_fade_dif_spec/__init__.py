...
from io_scs_tools_mod.internals.shaders.eut2.dif_spec_fade_dif_spec import detail_nmap
from io_scs_tools_mod.internals.shaders.eut2.dif_spec_fade_dif_spec import detail_setup_ng
