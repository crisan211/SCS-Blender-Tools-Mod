...
from io_scs_tools_mod.internals.shaders.eut2.sky import texture_types
...
def __create_node_group__():
    ...
    # inputs defining
    rescl_enabled_socket = rescale_g.interface.new_socket(name = "Rescale Enabled", in_out='INPUT', socket_type = 'NodeSocketFloat')
    rescl_enabled_socket.attribute_domain = 'POINT'

    v_scale_base_a_socket = rescale_g.interface.new_socket(name = "V Scale Base A", in_out='INPUT', socket_type = 'NodeSocketFloat')
    v_scale_base_a_socket.attribute_domain = 'POINT'

    v_scale_base_b_socket = rescale_g.interface.new_socket(name = "V Scale Base B", in_out='INPUT', socket_type = 'NodeSocketFloat')
    v_scale_base_b_socket.attribute_domain = 'POINT'

    v_scale_over_a_socket = rescale_g.interface.new_socket(name = "V Scale Over A", in_out='INPUT', socket_type = 'NodeSocketFloat')
    v_scale_over_a_socket.attribute_domain = 'POINT'

    v_scale_over_b_socket = rescale_g.interface.new_socket(name = "V Scale Over B", in_out='INPUT', socket_type = 'NodeSocketFloat')
    v_scale_over_b_socket.attribute_domain = 'POINT'

    uv_socket = rescale_g.interface.new_socket(name = "UV", in_out='INPUT', socket_type = 'NodeSocketVector')
    ...
    # outputs defining
    uv_base_a_socket = rescale_g.interface.new_socket(name = "UV Base A", in_out='OUTPUT', socket_type = 'NodeSocketVector')
    uv_base_a_socket.attribute_domain = 'POINT'

    uv_base_b_socket = rescale_g.interface.new_socket(name = "UV Base B", in_out='OUTPUT', socket_type = 'NodeSocketVector')
    uv_base_b_socket.attribute_domain = 'POINT'

    uv_over_a_socket = rescale_g.interface.new_socket(name = "UV Over A", in_out='OUTPUT', socket_type = 'NodeSocketVector')
    uv_over_a_socket.attribute_domain = 'POINT'

    uv_over_b_socket = rescale_g.interface.new_socket(name = "UV Over B", in_out='OUTPUT', socket_type = 'NodeSocketVector')
    uv_over_b_socket.attribute_domain = 'POINT'
