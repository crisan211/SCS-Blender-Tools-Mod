...
def __create_group__():
    ...
    # inputs defining
    near_dist_socket = detail_setup_g.interface.new_socket(name = "Near Distance", in_out='INPUT', socket_type = 'NodeSocketFloat')
    near_dist_socket.attribute_domain = 'POINT'

    far_dist_socket = detail_setup_g.interface.new_socket(name = "Far Distance", in_out='INPUT', socket_type = 'NodeSocketFloat')
    far_dist_socket.attribute_domain = 'POINT'

    scramble_dist_socket = detail_setup_g.interface.new_socket(name = "Scramble Distance", in_out='INPUT', socket_type = 'NodeSocketFloat')
    scramble_dist_socket.attribute_domain = 'POINT'

    input_n = detail_setup_g.nodes.new("NodeGroupInput")
    input_n.location = (start_pos_x, start_pos_y)

    # outputs defining
    mix_factor_socket = detail_setup_g.interface.new_socket(name = "Mix Factor", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
    mix_factor_socket.attribute_domain = 'POINT'

    scramble_mix_factor_socket = detail_setup_g.interface.new_socket(name = "Scramble Mix Factor", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
    scramble_mix_factor_socket.attribute_domain = 'POINT'
