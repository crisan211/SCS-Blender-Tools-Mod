...
from io_scs_tools_mod.internals.open_gl.shaders import get_shader, ShaderTypes
...
class _Buffer:
    ...
    def __init__(self, buffer_type, draw_size, shader_type, attr_names):
        ...
        if buffer_type == _Buffer.Types.LINES:
            ...
            gpu.state.line_width_set(self.__draw_size)
...
def draw_shape_line(line, stipple, is_map_line, scs_globals):
    ...
    :type scs_globals: io_scs_tools_mod.properties.world.GlobalSCSProps
    :return:
    :rtype:
    """
