...
from io_scs_tools_mod.internals.containers.parsers import sii as _sii_reader
from io_scs_tools_mod.internals.containers.writers import sii as _sii_writer
...
def write_data_to_file(filepath, container, is_sui=False, create_dirs=False):
    ...
    :type container: tuple[io_scs_tools_mod.internals.structure.UnitData]|list[io_scs_tools_mod.internals.structure.UnitData]
...
def has_valid_unit_instance(container, unit_type, req_props=tuple(), one_of_props=tuple(), unit_instance=0):
    ...
    :type container: list[io_scs_tools_mod.internals.structure.UnitData]
...
def get_unit_by_id(container, unit_id, unit_type):
    ...
    :rtype: None|io_scs_tools_mod.internals.structure.UnitData
    """
    unit = None
