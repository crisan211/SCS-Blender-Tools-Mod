...
bl_info = {
    ...
    "author": "Simon Lusenc (50keda), Milos Zajic (4museman), Mod by: Crisan21",
    "version": (1, 0),
    "blender": (4, 0, 0),
...
from io_scs_tools_mod.internals.callbacks import open_gl as _open_gl_callback
from io_scs_tools_mod.internals.callbacks import persistent as _persistent_callback
from io_scs_tools_mod.internals import icons as _icons
...
from io_scs_tools_mod.utils.view3d import has_view3d_space as _has_view3d_space
...
class SCS_TOOLS_OT_Import(bpy.types.Operator, ImportHelper):
    ...
    def execute(self, context):
        ...
        from io_scs_tools_mod.internals.containers.config import AsyncPathsInit
    ...
    def draw(self, context):
        ...
        from io_scs_tools_mod.ui.shared import get_on_off_icon
        from io_scs_tools_mod.ui.shared import draw_common_settings
        from io_scs_tools_mod.internals.containers.config import AsyncPathsInit
...
class SCS_TOOLS_OT_Export(bpy.types.Operator, _SCSExportHelper, ExportHelper):
    ...
    def draw(self, context):
        from io_scs_tools_mod.ui.shared import draw_export_panel
...
def register():
    ...
    from io_scs_tools_mod.properties import register as props_register
    props_register()
    ...
    # REGISTER UI
    from io_scs_tools_mod.ui import register as ui_register
    ui_register()

    # REGISTER OPERATORS
    from io_scs_tools_mod.operators import register as ops_register
    ops_register()
...
def unregister():
    ...
    from io_scs_tools_mod.operators import unregister as ops_unregister
    ops_unregister()

    # UNREGISTER UI
    from io_scs_tools_mod.ui import unregister as ui_unregister
    ui_unregister()
    ...
    # UNREGISTER PROPS
    from io_scs_tools_mod.properties import unregister as props_unregister
    props_unregister()
