...
from io_scs_tools_mod.exp import tobj as _tobj_exp
...
class Common:
    ...
    class SCS_TOOLS_OT_SearchShaderPreset(bpy.types.Operator):
        ...
        from io_scs_tools_mod.properties.addon_preferences import SCSInventories
...
class LampSwitcher:
    ...
    class SCS_TOOLS_OT_SwitchLampmask(bpy.types.Operator):
        ...
        def execute(self, context):
            ...
            from io_scs_tools_mod.internals.shaders.eut2.std_node_groups.lampmask_mixer_ng import LAMPMASK_MIX_G
...
class Aliasing:
    ...
    class SCS_TOOLS_OT_LoadAliasedMaterial(bpy.types.Operator):
        ...
        def execute(self, context):
            ...
            from io_scs_tools_mod.internals.containers import mat as mat_container
...
class Flavors:
    ...
    class SCS_TOOLS_OT_SwitchFlavor(bpy.types.Operator):
        ...
        def execute(self, context):
            ...
            """:type: io_scs_tools_mod.properties.material.MaterialSCSTools"""
