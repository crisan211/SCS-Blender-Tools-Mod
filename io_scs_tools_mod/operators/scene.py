...
from io_scs_tools_mod.consts import ConvHlpr as _CONV_HLPR_consts
from io_scs_tools_mod.consts import Operators as _OP_consts
from io_scs_tools_mod.consts import PaintjobTools as _PT_consts
from io_scs_tools_mod.imp import pix as _pix_import
from io_scs_tools_mod.internals.structure import UnitData as _UnitData
from io_scs_tools_mod.internals.containers import pix as _pix_container
from io_scs_tools_mod.internals.containers import sii as _sii_container
from io_scs_tools_mod.internals.containers.tobj import TobjContainer as _TobjContainer
...
from io_scs_tools_mod.utils.property import get_default as _get_default
from io_scs_tools_mod.utils.property import get_filebrowser_display_type
from io_scs_tools_mod import exp as _export
from io_scs_tools_mod import imp as _import
...
class Paths:
    ...
    class SCS_TOOLS_OT_AddPathPreset(bpy.types.Operator, AddPresetBase):
        ...
        preset_defines = [
            "scs_globals = bpy.context.preferences.addons['io_scs_tools_mod'].preferences.scs_globals"
        ]
        ...
        preset_subdir = "io_scs_tools_mod/paths"
...
class Log:
    ...
    class SCS_TOOLS_OT_CopyLogToClipboard(bpy.types.Operator):
        ...
        def execute(self, context):
            from io_scs_tools_mod.utils.printout import get_log
...
class PaintjobTools:
    ...
    class SCS_TOOLS_OT_ExportPaintjobUVLayoutAndMesh(bpy.types.Operator):
        ...
        def transform_uvs(obj, texture_portion):
            ...
            :type texture_portion: io_scs_tools_mod.internals.structure.UnitData
            """
    ...
    class SCS_TOOLS_OT_GeneratePaintjob(bpy.types.Operator):
        ...
        def append_prop_if_not_default(self, unit, prop_name, prop_value=None):
            ...
            :type unit: io_scs_tools_mod.internals.structure.UnitData
