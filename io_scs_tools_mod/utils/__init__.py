...
def __get_addon_prefs__():
    ...
    :rtype: io_scs_tools_mod.properties.addon_preferences.SCSAddonPrefs
    """
    return bpy.context.preferences.addons["io_scs_tools_mod"].preferences
...
def get_scs_globals():
    ...
    :rtype: io_scs_tools_mod.properties.world.GlobalSCSProps
    """
...
def get_scs_inventories():
    ...
    :rtype: io_scs_tools_mod.properties.addon_preferences.SCSInventories
    """
